...
public func getStarsDataFromApi(apiQueryUrl: String) {
    ...
    foundStarsList = [Star]()
        ...
        let jsonDataFromApi = getJsonDataFromApi(apiUrl: "https://api.themoviedb.org/3/movie/\(apiQueryUrl)?api_key=63b12df97bd2fdb9af3c015f7e427279&append_to_response=credits")
