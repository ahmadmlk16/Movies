...
public func readMovieDataFile() {
    ...
    let movieDataFilename = "MyMovieData.json"
   
    // Obtain URL of the Movie data file in document directory on user's device
    let urlOfJsonFileInDocumentDirectory = documentDirectory.appendingPathComponent(movieDataFilename)
 
    do {
        _ = try Data(contentsOf: urlOfJsonFileInDocumentDirectory)
       
        // Movie data file exists in the document directory
 
        movieStructList = loadFromDocumentDirectory(movieDataFilename)
        print("MovieData is loaded from document directory")
       
    } catch {
        // Movie data file does not exist in the document directory; Load it from the main bundle.
       
        movieStructList = loadFromMainBundle(movieDataFilename)
        print("MovieData is loaded from main bundle")
    }
}
 
/*
***********************************************
MARK: - Load Movie Data File from Main Bundle
***********************************************
*/
...
public func writeMovieDataFile() {
    ...
    let urlOfJsonFileInDocumentDirectory: URL? = documentDirectory.appendingPathComponent("MyMovieData.json")
...
/*
******************************************************
MARK: - Load Movie Data File from Document Directory
******************************************************
*/
...
/*
***************************************
MARK: - Get Movie Flag Image from URL
***************************************
