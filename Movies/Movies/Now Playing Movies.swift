...
public func getNowPlayingMoviesFromApi() {
    ...
    let jsonDataFromApi = getJsonDataFromApi(apiUrl: "https://api.themoviedb.org/3/movie/now_playing?api_key=63b12df97bd2fdb9af3c015f7e427279")
        ...
        do {
            ...
            for index in 0..<arrayOfHitsJsonObjects.count {
                ...
                let jsonDataFromApi = getJsonDataFromApi(apiUrl: "https://api.themoviedb.org/3/movie/\(tmdbID)?api_key=63b12df97bd2fdb9af3c015f7e427279&append_to_response=videos")
                ...
                let foundMovie = Movie(id: UUID(), title: title, posterFileName: posterFileName, overview: overview, genres: genres, releaseDate: releaseDate, runtime: runtime, director: director, actors: actors, mpaaRating: mpaaRating, imdbRating: imdbRating, youTubeTrailerId: youTubeTrailerId, tmdbID: tmdbID)
